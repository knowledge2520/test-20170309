    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url($this->lang->lang().'/business/edit/'.$business_id)?>"><?php echo lang('bc_business_edit')?></a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <a href="<?php echo site_url($this->lang->lang().'/business/mediaList/'.$business_id)?>"><?php echo lang('bc_business_media_list')?></a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <?php echo lang('bc_business_media_create')?>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light bordered form-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-blue-hoki bold uppercase"><?php echo lang('business_media_create')?></span>
                        </div>
                    </div>
                            ...
                            <div class="form-group <?php echo form_error('path') ? 'has-error' : ''; ?>">
                                ...
                                <div class="col-md-9">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 155px; height: 155px;">
                                        ...
                                        <div>
												...
												<?php echo lang('business_media_lbl_select_image')?> </span>
												<span class="fileinput-exists">
												<?php echo lang('business_media_lbl_change')?> </span>
												<input type="file" name="path">
												</span>
                                            <a href="#" class="btn red fileinput-exists" data-dismiss="fileinput">
                                                <?php echo lang('business_media_lbl_remove')?> </a>
                                        </div>
                                    </div>
                                    <div class="clearfix margin-top-10">
											<span class="label label-danger">
											<?php echo lang('business_media_lbl_note')?></span>&nbsp;
                                        <?php echo lang('business_media_lbl_image_upload_note')?>
                                    </div>      
                                    <div class="clearfix margin-top-10" style="color:#a94442">
                                        <?php echo form_error('path')?>
                                    </div>                              
                                </div>
                            </div>
                            <div class="form-group last">
                                <label class="control-label col-md-3"><?php echo lang('business_media_status')?></label>
                                <div class="col-md-9">
                                    <?php
                                    $status = array(
                                        '0'         => 'Deactivate',
