        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li><a href="<?php echo site_url($this->lang->lang().'/business/tips')?>"><?php echo lang('bc_tips')?></a>
                    <i class="fa fa-angle-right"></i></li>
                <li><?php echo lang('bc_tip_edit')?></li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
        <!-- BEGIN PAGE CONTENT-->
            ...
            <div class="col-md-12">
                ...
                <div class="tabbable tabbable-custom tabbable-full-width">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="<?php echo site_url($this->lang->lang().'/business/tips/mediaList/'.$record->id)?>">
                        ...
                        <div class="portlet light bordered form-fit">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-blue-hoki bold uppercase"><?php echo lang('tip_edit')?></span>
                                </div>
                            </div>
                            <div class="portlet-body form">
                                ...
                                <div class="form-body">
                                    <div class="form-group <?php echo form_error('user') ? 'has-error' : ''; ?>">
                                        <label class="control-label col-md-3"><?php echo lang('tip_user')?></label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="user" value="<?php echo isset($record->user) ? $record->user->first_name . ' ' . $record->user->last_name : '<i>N/A</i>';?>" readonly="">
                                    ...
                                    <div class="form-group <?php echo form_error('business') ? 'has-error' : ''; ?>">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="business" value="<?php echo isset($record->business) && !empty($record->business) ? $record->business->name : '';?>" readonly="">
