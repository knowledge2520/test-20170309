...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <h3 class="page-title">
            ...
            <small><?php echo lang('tip_media_list_header') ?></small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url($this->lang->lang().'/business/tips/edit/'.$tip_id)?>"><?php echo lang('bc_tip_edit')?></a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <?php echo lang('bc_tip_media_list')?>
                </li>
            </ul>
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown">
                        <?php echo lang('tip_media_actions')?> <i class="fa fa-angle-down"></i>
                    </button>
                    <ul class="dropdown-menu pull-right" role="menu">
                        <li>
                            <a href="<?php echo site_url($this->lang->lang().'/business/tips/mediaCreate/'.$tip_id)?>"><?php echo lang('tip_media_create')?></a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="portlet-body">
                    ...
                    <div class="tabbable tabbable-custom tabbable-full-width">
                        <ul class="nav nav-tabs">
                            <li>
                                <a href="<?php echo site_url($this->lang->lang().'/business/tips/edit/'.$tip_id)?>">
                                    <?php echo lang('tip_tab_general')?> </a>
                            </li>
                            <li class="active">
                                <a href="#">
                                        ...
                                        <div class="portlet-body">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="dataTables_length" id="dataTables_length">
                                                        <label>
                                                            ...
                                                            <?php echo lang('tip_media_records')?>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-sm-12">
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="10%"><?php echo lang('tip_media_id')?></th>
                                                    <th><?php echo lang('tip_media_media')?></th>
                                                    <th><?php echo lang('tip_media_author')?></th>                                                        
                                                    <th><?php echo lang('tip_media_status')?></th>                                                       
                                                    <th><?php echo lang('tip_media_dateUploaded')?></th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <?php if(!empty($records)):?>
                                                    <?php foreach($records as $record):?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo anchor(site_url($this->lang->lang().'/business/tips/mediaEdit/'.$tip_id.'/'.$record->id), $record->id)?></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                switch ($record->status){
                                                                    case 0: echo lang('tip_status_pending');break;
                                                                    case 1: echo lang('tip_status_active');break;
                                                                    case 2: echo lang('tip_status_delete');break;
                                                                    case 3: echo lang('tip_status_rejected');break;
                                                                }
                                                                ;?>
                                                            </td>     
