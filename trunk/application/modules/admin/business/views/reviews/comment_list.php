...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <h3 class="page-title">
            ...
            <small><?php echo lang('review_comment_list_header') ?></small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <?php echo lang('bc_review_comment_list')?>
                </li>
            </ul>
                                            ...
                                            <div class="portlet-body">
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="dataTables_length" id="dataTables_length">
                                                            <label>
                                                                ...
                                                                <?php echo lang('review_media_records')?>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-12">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th width="10%"><?php echo lang('review_comment_id')?></th>
                                                        <th><?php echo lang('review_comment_user')?></th>
                                                        <th><?php echo lang('review_comment_content')?></th>
                                                        <th><?php echo lang('review_comment_createdDate')?></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <?php if(!empty($records)):?>
                                                        <?php foreach($records as $record):?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo anchor(site_url($this->lang->lang().'/business/reviews/commentEdit/'.$review_id.'/'.$record->id), $record->id)?></td>
                                                                <td><?php echo (empty($record->first_name) && empty($record->last_name)) ? $record->username : $record->first_name.' '.$record->last_name;?></td>
