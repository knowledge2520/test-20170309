    ...
    <div class="page-toolbar">
        <div class="btn-group pull-right">
            <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown"
                ...
                <?php echo lang('review_actions') ?> <i class="fa fa-angle-down"></i>
            </button>
            <ul class="dropdown-menu pull-right" role="menu">
                <li>
                    <a href="<?php echo site_url($this->lang->lang() . '/business/reviews/create') ?>"><?php echo lang('review_create') ?></a>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="<?php echo site_url($this->lang->lang() . '/business/reviews/deactivate') ?>">
                                <?php echo lang('review_tab_deactivate') ?>
