            ...
            <div class="col-md-12">
                ...
                <div class="tabbable tabbable-custom tabbable-full-width">
                    <ul class="nav nav-tabs">
                        <li class="active"><a
                                href="<?php echo site_url($this->lang->lang() . '/business/approve_business/edit/' . $record->id) ?>">
                        <?php echo lang('business_tab_general') ?> </a>
                        </li>
                        <li><a
                                href="<?php echo site_url($this->lang->lang() . '/business/approve_business/mediaList/' . $record->id) ?>">
                    ...
                    <div class="tab-content">
                        <div class="portlet light bordered form-fit">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-user font-blue-hoki"></i> <span
                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="form-body">
                                            ...
                                            <div class="fileinput fileinput-new"
                                                ...
                                                <div class="fileinput-new thumbnail"
                                                     style="max-width: 155px; max-height: 155px;">
                                                        ...
                                                        <img
                                                            src="<?php echo CMSHelper::output_media($record->photo) ?>"
                                                            alt="" />
                                                        <?php else: ?>
                                                        <img
                                                ...
                                                <div class="fileinput-preview fileinput-exists thumbnail"
                                                     style="max-width: 155px; max-height: 155px;"></div>
                                                <div>
                                                    ...
                                                    </span> <a href="#" class="btn red fileinput-exists"
                                    ...
                                    <div
                                        class="form-group <?php echo form_error('name') ? 'has-error' : ''; ?>">
                                        <label class="control-label col-md-3"><?php echo lang('business_name') ?> <span
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="website"
                                                   value="<?php echo isset($record->website) ? $record->website : ''; ?>">
                                    ...
                                    <div
                                        class="form-group <?php echo form_error('address_location') ? 'has-error' : ''; ?>">
                                        <label class="control-label col-md-3"><?php echo lang('business_location') ?> <span
                                                class="required" aria-required="true"> * </span></label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control"
                                                   name="address_location" value=" <?php echo isset($record->address) ? $record->address : ''; ?>">
                                            <span class="help-block">
                                                Generate longitude and latitude base on the location address</span>
                                            <?php echo form_error('address_location') ?>
                                        </div>
                                    </div>
                                    <div
                                        class="form-group <?php echo form_error('latitude') ? 'has-error' : ''; ?>">
                                        <label class="control-label col-md-3"><?php echo lang('business_latitude') ?></label>

                                        <div class="col-md-9" id="lat">
                                            <input type="text" class="form-control" name="latitude"
                                                   value="<?php echo isset($record->latitude) ? $record->latitude : ''; ?>">
                                            <?php echo form_error('latitude') ?>
                                        </div>
                                    </div>
                                    <div
                                        class="form-group <?php echo form_error('longitude') ? 'has-error' : ''; ?>">
                                        <label class="control-label col-md-3"><?php echo lang('business_longitude') ?></label>

                                        <div class="col-md-9" id="long">
                                            <input type="text" class="form-control" name="longitude"
                                                   value="<?php echo isset($record->longitude) ? $record->longitude : ''; ?>">
                                            <?php echo form_error('longitude') ?>
                                        </div>
                                    </div>
                                    <div
                                        class="form-group <?php echo form_error('categories[]') ? 'has-error' : ''; ?>">
                                                            ...
                                                            <?php foreach ($categories_items as $c): $i = 0 ?>
                                                                <?php if (isset($record->categories) && !empty($record->categories)): ?>
                                                                    <?php foreach ($record->categories as $row): ?>
                                                                        <?php if ($c->id == $row->id): ?>
                                                                            <li><label><input
                                                                                        type="checkbox" value="<?php echo $c->id ?>"
                                                                                        name="categories[]" checked /> <?php echo $c->name ?>
                                                                                </label></li>
                                                                            <?php $i++;
                                                                            break;
                                                                            ?>
