...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo site_url($this->lang->lang() . '/business/approve_business/') ?>"><?php echo lang('bc_business_approve') ?></a>
        </li>
    </ul>    
</div>
<!-- END PAGE HEADER-->
                        ...
                        <div class="portlet box blue-hoki">
                            ...
                            <div class="portlet-body">
                                ...
                                <?php if (!empty($records)): ?>
                                    <?php echo form_open(site_url($this->lang->lang() . '/business/approve_business/index'), 'method="POST" name="form_listRecords" id="form_listRecords"') ?>
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                        <thead>
                                        <tr>
                                            <?php if(isset($permissions[$module.'.index']) || $is_admin):?>
                                        ...
                                        <?php foreach ($records as $record):?>
                                            <tr>
                                                ...
                                                <td><?php echo !empty($record->name) ? $record->name : '<i>N/A</i>';?></td>
                                                <td>
                                                    <?php 
                                                        if (isset($record->categories) && !empty($record->categories)){
                                                            $arr = [];
                                                            foreach ($record->categories as $key => $item) {
                                                                $arr[] = $item->name; 
                                                            }
                                                            echo implode(', ', $arr);
                                                        }
                                                ...
                                                <td><?php echo !empty($record->first_name) && !empty($record->last_name) ? $record->first_name . ' ' . $record->last_name : $record->email ?></td>
                                                <td><?php echo ellipsize($record->address, 30, 1)?></td>
                                                <td><?php echo ellipsize($record->hour, 50, 1) ?></td>
                                                <td><?php echo ellipsize($record->phone, 20, 1) ?></td>
                                                <td><?php echo ellipsize($record->website, 50, 1) ?></td>
                                                <td>
                                                    <?php                                                      
                                                ...
                                                <?php if($is_admin):?>
                                                    <td>                                                            
                                                        <a href="<?php echo site_url($this->lang->lang() . '/business/approve_business/edit/' . $record->id) ;?>"
