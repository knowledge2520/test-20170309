...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            <?php echo lang('business_media_header') ?>
            <small><?php echo lang('business_media_list_header') ?></small>
        </h3>
        <div class="page-bar">
            ...
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown">
                        <?php echo lang('business_media_actions')?> <i class="fa fa-angle-down"></i>
                    </button>
                    <ul class="dropdown-menu pull-right" role="menu">
                        <li>
                            <a href="<?php echo site_url($this->lang->lang().'/business/mediaCreate/'.$business_id)?>"><?php echo lang('business_media_create')?></a>
                        </li>
                    </ul>
                </div>
            </div>
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <?php echo lang('business_media_media')?>                                                            
                                                        </th>
                                                        <th>
                                                            ...
                                                            <?php 
                                                                echo lang('business_media_author');
                                                        ...
                                                        <th>
                                                            <?php echo lang('business_media_status')?>
                                                        </th>                                                       
                                                        <th>
                                                        ...
                                                        <?php foreach($records as $record):?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                 ...
                                                                 <td>                                                            
                                                                    <a href="<?php echo site_url($this->lang->lang().'/business/mediaEdit/'.$business_id.'/'.$record->id) ;?>"
