...
<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
    <?php echo lang('business_trash_header') ?>
    <small><?php echo lang('business_trash_listing_header')?></small>
</h3>
...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <?php echo lang('bc_business_trash') ?>
        </li>
    </ul>
    ...
    <div class="col-md-12">
        <div class="portlet-body">
            ...
            <div class="tabbable tabbable-custom tabbable-full-width">
                   ...
                   <?php if($key):?>
                   		<?php 
                   			$url = get_url($key, 'business/trash?country=');
	                        ...
	                        <div class="portlet box blue-hoki">
	                            ...
	                            <div class="portlet-body">
	                                ...
	                                <?php if (!empty($records)): ?>
	                                    <?php echo form_open(site_url($this->lang->lang() . '/business/trash/index'), 'method="POST" name="form_listRecords" id="form_listRecords"') ?>
	                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
	                                        ...
	                                        <?php foreach ($records as $record):?>
	                                            <tr <?php if(!($record->latitude && $record->longitude)) echo 'class="strong-row-item"'; ?>>
                                                    ...
                                                    <?php if(isset($permissions[$module.'.edit']) || $is_admin || $record->individual):?>
                                                        <td>                                                            
                                                            <a href="<?php echo site_url($this->lang->lang() . '/business/trash/detail/' . $record->id) ;?>"
                                                                class="btn default btn-xs purple"> <i class="fa fa-eye"></i> <?php echo lang('btn_detail'); ?>
                                                            </a>
                                                        </td>
                                                    <?php endif?>
	                                            </tr>
	                                ...
	                                <div class="row">
	                                    <div class="col-md-7 col-sm-12">
	                                        ...
	                                        <br/>
	                                        <a href="#" data-href="" class="restore-dialog" data-toggle="modal" data-target="#confirm-restore"><button  class="btn btn blue">Restore</button></a>    
                                    ...
                                    <div class="modal fade" id="confirm-restore" tabindex="-1" role="basic" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <input type="submit" class="btn btn-danger" name="btn_restore" id="delete" value="Restore">
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        </div>
