                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="portlet box blue-hoki">
                                                        ...
                                                        <div class="portlet-body">
                                                            <div class="row">
                                                                <?php echo form_open(site_url($this->lang->lang().'/business/activity/index/'. $business_id),'method="GET" name="form_searchResult_Filter" id="form_searchResult_Filter"')?> 
                                                                <div class="col-md-3">
                                                             ...
                                                             <div class="row">
                                                                <?php echo form_open(site_url($this->lang->lang().'/business/activity/index/'.$business_id),'method="GET" name="form_searchResult" id="form_searchResult"')?>
                                                            ...
                                                            <?php echo form_open(site_url($this->lang->lang().'/business/activity/index/'.$business_id),'method="POST" name="form_listRecords" id="form_listRecords"')?>
