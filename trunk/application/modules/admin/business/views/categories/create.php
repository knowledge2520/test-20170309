    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li><a href="<?php echo site_url($this->lang->lang().'/business/categories')?>"><?php echo lang('bc_categories')?></a>
                    <i class="fa fa-angle-right"></i></li>
                ...
                <div class="portlet light bordered form-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-blue-hoki bold uppercase"><?php echo lang('category_create')?></span>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-3"><?php echo lang('category_profilePhoto')?></label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group <?php echo form_error('description') ? 'has-error' : ''; ?>">
                                <label class="control-label col-md-3"><?php echo lang('category_description')?></label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group <?php echo form_error('position') ? 'has-error' : ''; ?>">
                                <label class="control-label col-md-3"><?php echo lang('category_position')?></label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="position" value="<?php echo isset($record->position) ? $record->position : '';?>">
                                    <?php echo form_error('position')?>
                                </div>
                            </div>
                            <div class="form-group last">
                                <label
                                    class="control-label col-md-3"><?php echo lang('category_status') ?></label>
