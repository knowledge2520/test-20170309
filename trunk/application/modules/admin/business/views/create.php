            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group <?php echo form_error('name') ? 'has-error' : ''; ?>">
                        <label class="control-label col-md-3"><?php echo lang('business_edit_name')?> <span class="required" aria-required="true"> * </span></label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group <?php echo form_error('address_location') ? 'has-error' : ''; ?>">
                        <label class="control-label col-md-3"><?php echo lang('business_location')?> <span class="required" aria-required="true"> * </span></label>
                            <div class="col-md-9">
