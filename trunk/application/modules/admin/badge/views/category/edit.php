...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            <?php echo lang('bc_badge_category_edit')?>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li><?php echo lang('bc_badge_category_edit')?></li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
        <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="portlet light bordered form-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-blue-hoki bold uppercase"><?php echo lang('bc_badge_category_edit')?></span>
                        </div>
                    </div>
