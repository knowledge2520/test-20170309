...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            <?php echo lang('badge_category_header')?>
        </h3>
        <div class="page-bar">
            ...
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown">
                        <?php echo lang('badge_category_actions')?> <i class="fa fa-angle-down"></i>
                    </button>
                    <ul class="dropdown-menu pull-right" role="menu">
                        <li>
                            <a href="<?php echo site_url($this->lang->lang().'/badge/category/create')?>"><?php echo lang('badge_category_create')?></a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet box blue-hoki">
                                    ...
                                    <div class="portlet-body">
                                        <div class="row">
                                            <?php echo form_open(site_url($this->lang->lang().'/badge/category/index'),'method="GET" name="form_searchResult" id="form_searchResult"')?>
                                        ...
                                        <?php echo form_open(site_url($this->lang->lang().'/badge/category/index'),'method="POST" name="form_listRecords" id="form_listRecords"')?>
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    ...
                                                    <?php 
                                                        echo lang('badge_category_description') . ' ';
                                                ...
                                                <th><?php echo lang('badge_category_status')?></th>
                                            ...
                                            <?php if(!empty($records)): $no = $offset +1;?>
                                                <?php foreach($records as $record):?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo ($record->status == 0) ? lang('badge_category_status_deactivate') : lang('badge_category_status_active')?></td>
                                                        <?php if(isset($permissions[$module.'.edit']) || $is_admin || $record->individual):?>
                                                        <td>                                                            
                                                            <a href="<?php echo site_url($this->lang->lang() . '/badge/category/edit/' . $record->id) ;?>"
