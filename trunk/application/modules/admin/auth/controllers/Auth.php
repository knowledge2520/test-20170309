...
class Auth extends CI_Controller {
	...
	function index()
	{
		...
		else
		{
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('error_message');
	...
	function login()
	{
		...
		$this->data['theme_path'] = site_url() . '../themes/'.$this->config->item('layout_path');
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), SHA1($this->input->post('password')), $remember))
			{
	...
	function create_group()
	{
		...
		else
		{
			...
			//set the flash data error message if there is one
			$this->data['message'] = (validation_errors() ? validation_errors() : ($this->ion_auth->errors() ? $this->ion_auth->errors() : $this->session->flashdata('error_message')));
