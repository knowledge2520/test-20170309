...
class Media_model extends MY_Model
{
     ...
     *file_name
     */
    public function getItems($option = 'total' , $status = false , $keyword = '' , $order_field = 'id' , $sort = 'ASC'  ,$limit = ADMIN_ITEMS_PERPAGE , $offset = false, $member_id = false, $key = false, $value = false){
        if($member_id){
