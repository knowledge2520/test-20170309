            ...
            <ul class="nav nav-tabs">
                ...
                <li class="active">
                    <a href="<?php echo site_url($this->lang->lang().'/business/checkins/deactivate')?>">
                        <?php echo lang('checkin_tab_deactivate')?>&nbsp;<?php echo (isset($total) && $total != 0) ? '<span class="badge badge-danger">'.$total.'</span>' : ''?>
                    </a>
                                    ...
                                    <?php if(isset($records) && !empty($records)):?>
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <tr>
                                                ...
                                                <th><?php echo lang('checkin_id')?></th>
                                                <th><?php echo lang('checkin_view')?></th>
                                                <th><?php echo lang('checkin_user')?></th>
                                                <th><?php echo lang('checkin_business')?></th>
                                                <th><?php echo lang('checkin_comment')?></th>
                                                <th><?php echo lang('checkin_created_date')?></th>
                                            ...
                                            <?php foreach($records as $record):?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo site_url($this->lang->lang() . '/business/checkins/edit/'. $record->id)?>"><?php echo ($record->status == 0) ? lang('checkin_status_deactivate') : lang('checkin_status_active')?></a></td>
