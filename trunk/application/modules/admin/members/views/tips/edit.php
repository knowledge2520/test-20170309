                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="form-body">
                                    <div class="form-group <?php echo form_error('user') ? 'has-error' : ''; ?>">
                                        ...
                                        <div class="col-md-9">
                                            <?php echo form_input('user',set_value('user',isset($record->user) ? $record->user : ''), ' class="form-control" readonly')?>
                                    ...
                                    <div class="form-group <?php echo form_error('business') ? 'has-error' : ''; ?>">
                                        ...
                                        <div class="col-md-9">
                                            <?php echo form_input('business',set_value('business',isset($record->business) ? $record->business : ''), ' class="form-control" readonly')?>
