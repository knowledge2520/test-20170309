                        ...
                        <ul class="nav nav-tabs">
                            <li>
                                <a href="<?php echo site_url($this->lang->lang() . '/members/edit/' . $member_id) ?>">
                                    <?php echo lang('tip_tab_member') ?> </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url($this->lang->lang() . '/members/mediaList/' . $member_id) ?>">
                                    <?php echo lang('tip_tab_pet') ?> </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url($this->lang->lang() . '/members/bookmarks/index/' . $member_id) ?>">
                                    <?php echo lang('tip_tab_bookmark') ?> </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url($this->lang->lang() . '/members/media/index/' . $member_id) ?>">
                            ...
                            <li class="active">
                                <a href="<?php echo site_url($this->lang->lang() . '/members/tips/index/' . $member_id) ?>">
                                            ...
                                            <div class="portlet box blue-hoki">
                                                ...
                                                <div class="portlet-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            <div class="dataTables_length" id="dataTables_length">
                                                                <label>
                                                                    ...
                                                                    <?php echo lang('tip_records') ?>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 col-sm-12">
                                                            <div id="sample_1_filter" class="dataTables_filter">
                                                                <label><?php echo lang('tip_my_search') ?>:
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            <div
                                                                class="text-right"> <?php echo ($pagination) ? $pagination : '' ?></div>
                                                        </div>
                                                        <?php echo form_close() ?>
                                                    </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover"
                                                            ...
                                                            <?php foreach ($records as $record): ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo anchor(site_url($this->lang->lang() . '/s/tips/edit/' . $record->id), !empty($record->name) ? $record->name : '<i>none</i>') ?></td>
