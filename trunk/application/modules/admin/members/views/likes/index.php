...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            <?php echo lang('like_header') ?>
            <small><?php echo lang('like_list_header') ?></small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url($this->lang->lang().'/members/likes')?>"><?php echo lang('bc_likes')?></a>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><?php echo lang('like_id')?></th>
                                                        <th><?php echo lang('like_user')?></th>
                                                        <th><?php echo lang('like_tip')?></th>
                                                        <th><?php echo lang('like_topic')?></th>
                                                        <th><?php echo lang('like_product')?></th>
                                                        <th><?php echo lang('like_created_date')?></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        <?php foreach($records as $record):?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php
                                                                        if($record->user_id){
                                                                            echo anchor(site_url($this->lang->lang().'/members/edit/'.$record->user_id),(empty($record->user->first_name) && empty($record->user->last_name)) ? '<i>none</i>' : $record->user->first_name . ' ' . $record->user->last_name);
                                                                        }
                                                                    ?>
                                                                </td>
                                                                <td>
                                                                    <?php
                                                                    if($record->tip_id){
                                                                        echo anchor(site_url($this->lang->lang().'/business/tips/edit/'.$record->tip_id),empty($record->tip->name) ? '<i>none</i>' : $record->tip->name);
                                                                    }
                                                                    ?>
                                                                </td>
                                                                <td>
                                                                    <?php
                                                                    if($record->topic_id){
                                                                        echo anchor(site_url($this->lang->lang().'/pet_talk/edit/'.$record->topic_id), empty($record->topic->title) ? '<i>none</i>' : $record->topic->title);
                                                                    }
                                                                    ?>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    if($record->product_id){
                                                                        echo anchor(site_url($this->lang->lang().'/products/edit/'.$record->product_id), empty($record->product->name) ? '<i>none</i>' : $record->product->name);
                                                                    }
                                                                    ?>
                                                                </td>
                                                    ...
                                                    <?php else:?>
                                                        <tr>
                                                            <td colspan="6"><?php echo lang('like_empty_data')?></td>
                                                        </tr>
                                                    <?php endif;?>
                                                    </tbody>
                                                </table>
