...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            <?php echo lang('bookmark_header') ?>
            <small><?php echo lang('bookmark_list_header') ?></small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url($this->lang->lang().'/members/bookmarks')?>"><?php echo lang('bc_bookmarks')?></a>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><?php echo lang('bookmark_id')?></th>
                                                        <th><?php echo lang('bookmark_business')?></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
