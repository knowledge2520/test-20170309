                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                ...
                                                <tr>
                                                    ...
                                                    <th><?php echo lang('pet_id')?></th>
                                                    <th><?php echo lang('pet_name')?></th>
                                                    <th><?php echo lang('pet_dob')?></th>
                                                    <th><?php echo lang('pet_type')?></th>
                                                    <th><?php echo lang('pet_breed')?></th>
                                                    <th><?php echo lang('pet_sex')?></th>
                                                    <th><?php echo lang('pet_color')?></th>
                                                    <th><?php echo lang('pet_purchase_date')?></th>
                                                    <th><?php echo lang('pet_origin')?></th>
                                                    <th><?php echo lang('pet_microchip')?></th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <?php if(!empty($records)):?>
                                                    <?php foreach($records as $record):?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo get_time_date($record->dob);?></td>
                                                            <td><?php echo $record->type_pet;?></td>
                                                            <td><?php echo $record->breed;?></td>
                                                            <td><?php echo (strtolower($record->sex)=='male') ? 'Male' : 'Female';?></td>
                                                            <td><?php echo $record->color;?></td>
                                                            <td><?php echo get_time_date($record->purchase_date);?></td>
                                                            <td><?php echo $record->origin;?></td>
                                                            <td><?php echo $record->microchip;?></td>
                                                        </tr>
                                                    <?php endforeach;?>
                                                <?php endif;?>
                                                </tbody>
