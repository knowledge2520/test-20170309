...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <h3 class="page-title">
            ...
            <small><?php echo lang('review_media_edit_header') ?></small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <?php echo lang('bc_review_media_edit')?>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light bordered form-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-blue-hoki bold uppercase"><?php echo lang('review_media_edit')?></span>
                        </div>
                    </div>
