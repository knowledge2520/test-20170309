                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        <a href="<?php echo site_url($this->lang->lang().'/business/reviews/deactivate')?>">
                            <?php echo lang('review_tab_deactivate')?>&nbsp;<?php echo (isset($total) && $total != 0) ? '<span class="badge badge-danger">'.$total.'</span>' : ''?>
                        </a>
                                        ...
                                        <?php if(isset($records) && !empty($records)):?>
                                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                ...
                                                <tr>
                                                    ...
                                                    <th><?php echo lang('review_user')?></th>
                                                ...
                                                <?php foreach($records as $record):?>
                                                    <tr>
                                                        ...
                                                        <td><a href="<?php echo site_url($this->lang->lang().'/business/reviews/edit/'.$record->id)?>"><?php echo !empty($record->name) ? ellipsize($record->name,20) : '<i>none</i>' ?></a></td>
                                                        ...
                                                        <td><?php echo ($record->status == 0) ? lang('review_status_deactivate') : lang('review_status_active')?></td>
                                                    </tr>
                                                <?php endforeach;?>
                                                </tbody>
                                            </table>
