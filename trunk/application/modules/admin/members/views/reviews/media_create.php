...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <h3 class="page-title">
            ...
            <small><?php echo lang('review_media_create_header') ?></small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url($this->lang->lang().'/business/reviews/mediaList/'.$review_id)?>"><?php echo lang('bc_review_media_list')?></a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <?php echo lang('bc_review_media_create')?>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light bordered form-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-blue-hoki bold uppercase"><?php echo lang('review_media_create')?></span>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-3"><?php echo lang('review_media_profilePhoto')?></label>
                                <div class="col-md-9">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div>
												...
												<?php echo lang('review_media_lbl_select_image')?> </span>
												<span class="fileinput-exists">
												<?php echo lang('review_media_lbl_change')?> </span>
												<input type="file" name="path">
												</span>
                                            <a href="#" class="btn red fileinput-exists" data-dismiss="fileinput">
                                                <?php echo lang('review_media_lbl_remove')?> </a>
                                        </div>
                                    </div>
                                    <div class="clearfix margin-top-10">
											<span class="label label-danger">
											<?php echo lang('review_media_lbl_note')?></span>&nbsp;
                                        <?php echo lang('review_media_lbl_image_upload_note')?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group last">
                                <label class="control-label col-md-3"><?php echo lang('review_media_status')?></label>
                                <div class="col-md-9">
                                    <?php
                                    $status = array(
                                        '0'         => 'Deactivate',
