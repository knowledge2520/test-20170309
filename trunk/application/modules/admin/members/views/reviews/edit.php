    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li><a href="<?php echo site_url($this->lang->lang().'/members/reviews/index/'.$member_id)?>"><?php echo lang('bc_reviews')?></a>
                    <i class="fa fa-angle-right"></i></li>
            ...
            <div class="col-md-12">
                ...
                <div class="tabbable tabbable-custom tabbable-full-width">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="<?php echo site_url($this->lang->lang().'/members/reviews/mediaList/'.$member_id.'/'.$record->id)?>">
