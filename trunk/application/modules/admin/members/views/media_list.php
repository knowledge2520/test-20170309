...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            <?php echo lang('media_header') ?>
            <small><?php echo lang('media_list_header') ?></small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <?php echo lang('bc_member_media_list')?>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
                                            ...
                                            <div class="portlet-body">
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-6">
                                                        <div class="dataTables_length" id="dataTables_length">
                                                            <label>
                                                                ...
                                                                <?php echo lang('member_media_records')?>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-xs-6">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th width="10%"><?php echo lang('member_media_id')?></th>
                                                        <th><?php echo lang('member_media_media')?></th>
                                                        <th><?php echo lang('member_media_status')?></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <?php if(!empty($records)):?>
                                                        <?php foreach($records as $record):?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo anchor(site_url($this->lang->lang().'/members/mediaEdit/'.$member_id.'/'.$record->id), $record->id)?></td>
                                                                <td><img alt="" src="<?php echo CMSHelper::output_media($record->source) ?>" width="75px"></td>
                                                                <td><?php echo ($record->status ==0) ? lang('member_status_deactivate') : lang('member_status_active')?></td>
                                                            </tr>
                                                        <?php endforeach;?>
                                                    <?php endif;?>
                                                    </tbody>
