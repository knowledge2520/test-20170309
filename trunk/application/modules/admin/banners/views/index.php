...
<div class="page-content">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="<?php echo site_url($this->lang->lang().'/banners')?>"><?php echo lang('bc_banner')?></a>
            </li>
        </ul>
        ...
        <div class="page-toolbar">
            <div class="btn-group pull-right">
                <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown">
                    <?php echo lang('banner_actions')?> <i class="fa fa-angle-down"></i>
                </button>
                <ul class="dropdown-menu pull-right" role="menu">
                    <li>
                        <a href="<?php echo site_url($this->lang->lang().'/banners/create')?>"><?php echo lang('banner_create')?></a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue-hoki">
                                ...
                                <div class="portlet-body">
                                    <div class="row">
                                        <?php echo form_open(site_url($this->lang->lang().'/banners/index'),'method="GET" name="form_searchResult" id="form_searchResult"')?>
                                    ...
                                    <?php echo form_open(site_url($this->lang->lang().'/banners/index'),'method="POST" name="form_listRecords" id="form_listRecords"')?>
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <a class="header-table" href="<?php echo get_url_query($current_url, $query_url, ['order_field' => 'order', 'sort' => $order_field == "order" ? ($sort == "DESC" ? "ASC" : "DESC") : "DESC"]);?>" >
                                                <?php 
                                                    echo lang('banner_order') . ' ';
                                        ...
                                        <?php if(!empty($records)):?>
                                            <?php foreach($records as $record):?>
                                                <tr>
                                                    ...
                                                    <td><img src="<?php echo CMSHelper::output_media($record->path)?>" alt="" style="max-width: 320px; max-height: 160px"/> </td>                                                    
                                                    ...
                                                    <?php if(isset($permissions[$module.'.edit']) || $is_admin ):?>
                                                        <td>
                                                            <a href="<?php echo site_url($this->lang->lang() . '/banners/edit/' . $record->id) ;?>"
