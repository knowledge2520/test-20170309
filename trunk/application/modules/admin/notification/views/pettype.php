                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Select Pet Type</label>
                                                <div class="col-md-9">
                                                    <?php if(!empty($pettypes)):?>
                                                        <select name="pettypes[]" multiple="multiple" class="multi-select" id="my_multi_select1" style="width:300px" size="12">
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <input type="hidden" name="options" value="pettype">
                                                    <a href="<?php echo site_url('notification');?>"><button type="button" name="submit" value="pettype" class="btn default"> Back</button></a>
                                                    <button type="submit" name="submit" value="pettype" class="btn blue"><i class="fa fa-check"></i> Publish</button>
                                                </div>
                                            </div>
                                        </div>
                                        <?php echo form_close() ?>
