<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <h3 class="page-title">
            ...
            <small><?php echo lang('notification_all') ?></small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                 ...
                 <li>
                     <span> <?php echo lang('bc_notification_all') ?> </span>
                </li>  
            </ul>            
        </div>
        <!-- END PAGE HEADER-->
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    ...
                                                    <button type="submit" name="submit" value="all" class="btn blue"><i class="fa fa-check"></i> Publish </button>
                                                </div>
                                            </div>
                                        </div>
                                        <?php echo form_close() ?>
