...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <h3 class="page-title">
            ...
            <small><?php echo lang('pet_type_create_header')?></small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li><a href="<?php echo site_url($this->lang->lang().'/pets/pet_types')?>"><?php echo lang('bc_pet_type')?></a>
                    <i class="fa fa-angle-right"></i></li>
                <li><?php echo lang('bc_pet_type_create')?></li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
        <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="portlet light bordered form-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-blue-hoki bold uppercase"><?php echo lang('pet_type_create')?></span>
                        </div>
                    </div>
