...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <h3 class="page-title">
            ...
            <small><?php echo lang('pet_allergies_header') ?></small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <?php echo lang('bc_pet_allergies')?>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo lang('pet_allergy_id');?></th>
                                            <th><?php echo lang('pet_allergy_name');?></th>
                                            <th><?php echo lang('pet_allergy_reaction');?></th>
                                            <th><?php echo lang('pet_allergy_remedy');?></th>
                                            <th><?php echo lang('pet_allergy_last_update');?></th>
                                            <th><?php echo lang('pet_allergy_notes');?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php if(isset($records) && !empty($records)):?>
                                            <?php foreach($records as $record):?>
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td><?php echo $record->remedy;?></td>
                                                    <td><?php echo get_time_date($record->last_update);?></td>
