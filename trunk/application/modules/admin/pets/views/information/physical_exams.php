...
<h3 class="page-title">
    ...
    <small><?php echo lang('pet_physical_exams_header') ?></small>
</h3>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <?php echo lang('bc_pet_physical_exams')?>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo lang('pet_physical_exam_id');?></th>
                                    <th><?php echo lang('pet_physical_exam_perform_by');?></th>
                                    <th><?php echo lang('pet_physical_exam_clinic');?></th>
                                    <th><?php echo lang('pet_physical_exam_weight');?></th>
                                    <th><?php echo lang('pet_physical_exam_temperature');?></th>
                                    <th><?php echo lang('pet_physical_exam_pulse');?></th>
                                    <th><?php echo lang('pet_physical_exam_notes');?></th>
                                    <th><?php echo lang('pet_physical_exam_follow_up');?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(isset($records) && !empty($records)):?>
                                    <?php foreach($records as $record):?>
                                        <tr role="row" class="filter">
                                            ...
                                            <td><?php echo $record->perform_by;?></td>
