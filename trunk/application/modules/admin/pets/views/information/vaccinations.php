...
<h3 class="page-title">
    ...
    <small><?php echo lang('pet_vaccinations_header') ?></small>
</h3>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <?php echo lang('bc_pet_vaccinations')?>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo lang('pet_vaccination_id');?></th>
                                    <th><?php echo lang('pet_vaccination_name');?></th>
                                    <th><?php echo lang('pet_vaccination_use_date');?></th>
                                    <th><?php echo lang('pet_vaccination_clinic');?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(isset($records) && !empty($records)):?>
                                    <?php foreach($records as $record):?>
                                        <tr role="row" class="filter">
                                            ...
                                            <td><?php echo get_time_date($record->use_date);?></td>
