...
<h3 class="page-title">
    ...
    <small><?php echo lang('pet_weight_header') ?></small>
</h3>
<div class="page-bar">
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo lang('pet_weight_id');?></th>
                                    <th><?php echo lang('pet_weight_date');?></th>
                                    <th><?php echo lang('pet_weight_weight');?></th>
                                    <th><?php echo lang('pet_weight_type');?></th>
                                    <th><?php echo lang('pet_weight_notes');?></th>
                                </tr>
                                </thead>
                                <tbody>
