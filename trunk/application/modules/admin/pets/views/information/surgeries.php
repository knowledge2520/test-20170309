...
<h3 class="page-title">
    ...
    <small><?php echo lang('pet_surgeries_header') ?></small>
</h3>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <?php echo lang('bc_pet_surgeries')?>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo lang('pet_surgery_id');?></th>
                                    <th><?php echo lang('pet_surgery_type');?></th>
                                    <th><?php echo lang('pet_surgery_reason');?></th>
                                    <th><?php echo lang('pet_surgery_clinic');?></th>
                                    <th><?php echo lang('pet_surgery_doctor_name');?></th>
                                    <th><?php echo lang('pet_surgery_date');?></th>
                                    <th><?php echo lang('pet_surgery_notes');?></th>
                                    <th><?php echo lang('pet_surgery_result');?></th>
                                    <th><?php echo lang('pet_surgery_follow_up');?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(isset($records) && !empty($records)):?>
                                    <?php foreach($records as $record):?>
                                        <tr role="row" class="filter">
                                            ...
                                            <td><?php echo get_time_date($record->surgeny_date);?></td>
