...
<h3 class="page-title">
    ...
    <small><?php echo lang('pet_estrus_header') ?></small>
</h3>
<div class="page-bar">
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo lang('pet_estrus_id');?></th>
                                    <th><?php echo lang('pet_estrus_start_date');?></th>
                                    <th><?php echo lang('pet_estrus_end_date');?></th>
                                    <th><?php echo lang('pet_estrus_notes');?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(isset($records) && !empty($records)):?>
                                    <?php foreach($records as $record):?>
                                        <tr role="row" class="filter">
                                            ...
                                            <td><?php echo get_time_date($record->start_date);?></td>
                                            <td><?php echo get_time_date($record->end_date);?></td>
