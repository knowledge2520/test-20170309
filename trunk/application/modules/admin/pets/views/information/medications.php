...
<h3 class="page-title">
    ...
    <small><?php echo lang('pet_medications_header') ?></small>
</h3>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <?php echo lang('bc_pet_medications')?>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo lang('pet_medication_id');?></th>
                                    <th><?php echo lang('pet_medication_name');?></th>
                                    <th><?php echo lang('pet_medication_purpose');?></th>
                                    <th><?php echo lang('pet_medication_dosage');?></th>
                                    <th><?php echo lang('pet_medication_notes');?></th>
                                </tr>
                                </thead>
                                <tbody>
