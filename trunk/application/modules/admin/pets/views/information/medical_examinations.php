...
<h3 class="page-title">
    ...
    <small><?php echo lang('pet_medical_examinations_header') ?></small>
</h3>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <?php echo lang('bc_pet_medical_examinations')?>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo lang('pet_medical_examination_id');?></th>
                                    <th><?php echo lang('pet_medical_examination_type');?></th>
                                    <th><?php echo lang('pet_medical_examination_reason');?></th>
                                    <th><?php echo lang('pet_medical_examination_clinic');?></th>
                                    <th><?php echo lang('pet_medical_examination_doctor_name');?></th>
                                    <th><?php echo lang('pet_medical_examination_date');?></th>
                                    <th><?php echo lang('pet_medical_examination_notes');?></th>
                                    <th><?php echo lang('pet_medical_examination_result_date');?></th>
                                    <th><?php echo lang('pet_medical_examination_result');?></th>
                                    <th><?php echo lang('pet_medical_examination_follow_up');?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(isset($records) && !empty($records)):?>
                                    <?php foreach($records as $record):?>
                                        <tr role="row" class="filter">
                                            ...
                                            <td><?php echo $record->clinic;?></td>
                                            <td><?php echo $record->doctor_name;?></td>
                                            <td><?php echo get_time_date($record->date);?></td>
                                            <td><?php echo $record->notes;?></td>
                                            <td><?php echo get_time_date($record->result_date);?></td>
                                            <td><?php echo $record->result;?></td>
                                            <td><?php echo $record->follow_up;?></td>
                                        </tr>
                                    <?php endforeach?>
                                <?php endif?>
                                </tbody>
