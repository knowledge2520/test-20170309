...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            <?php echo lang('transaction_header')?>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url($this->lang->lang().'/products/transactions')?>"><?php echo lang('bc_transaction')?></a>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet box blue-hoki">
                                    ...
                                    <div class="portlet-body">
                                        <div class="row">
                                            <?php echo form_open(site_url($this->lang->lang().'/products/transactions/index'),'method="GET" name="form_searchResult" id="form_searchResult"')?>
                                        ...
                                        <?php echo form_open(site_url($this->lang->lang().'/products/transactions/index'),'method="POST" name="form_listRecords" id="form_listRecords"')?>
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <tr>
                                                ...
                                                <th><?php echo lang('transaction_user')?></th>
                                                <th><?php echo lang('transaction_product')?></th>
                                                <th><?php echo lang('transaction_color')?></th>
                                                <th><?php echo lang('transaction_size')?></th>
                                                <th><?php echo lang('transaction_order_code')?></th>
                                                <th><?php echo lang('transaction_quantity')?></th>
                                                <th><?php echo lang('transaction_status')?></th>
                                                <th><?php echo lang('transaction_price')?></th>
                                                <th><?php echo lang('transaction_subtotal')?></th>
                                                <th><?php echo lang('transaction_created_date')?></th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <?php if(!empty($records)):?>
                                                <?php foreach($records as $record):?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $record->product->name?></td>
                                                        <td><div style="background-color: <?php echo $record->color->color?>; width: 30px;height: 30px; border: solid 1px #000000"></div></td>
                                                        <td><?php echo $record->size->size?></td>
                                                        <td><?php echo $record->order->order_code?></td>
                                                        <td><?php echo $record->qty?></td>
                                                        <td><?php echo $record->order->payment_status?></td>
                                                        <td><?php echo $record->price?></td>
                                                        <td><?php echo $record->subtotal?></td>
                                                        <td><?php echo date('m-d-Y H:m:s',$record->created_date)?></td>
                                                    </tr>
                                                <?php endforeach;?>
                                            <?php endif;?>
                                            </tbody>
