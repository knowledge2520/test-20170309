            ...
            <div class="col-md-12">
                ...
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-shopping-cart"></i><?php echo lang('bc_product_size')?>
                        </div>
                    </div>
                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content no-space">
                                <div id="tab_3" class="tab-pane active">
                                    <?php echo form_open(site_url($this->lang->lang() . '/products/size/index/'.$record->id), 'method="POST" name="form_listRecords" id="form_listRecords"') ?>
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th width="10%"><?php echo lang('size_id') ?></th>
                                            <th><?php echo lang('size_size') ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php if (!empty($size)): ?>
                                            <?php foreach ($size as $item): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo anchor(site_url($this->lang->lang() . '/products/size/edit/' . $record->id . '/' . $item->id), $item->id) ?></td>
