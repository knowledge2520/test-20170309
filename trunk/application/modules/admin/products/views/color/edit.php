    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <?php echo lang('bc_product_color_edit') ?>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered form-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-blue-hoki bold uppercase"><?php echo lang('product_color_edit')?></span>
                        </div>
                    </div>
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group color colorpicker-default"
                                         data-color="<?php echo isset($record->color) ? $record->color : '' ?>"
                                         data-color-format="rgba">
                                        <input type="text" class="form-control"
                                               value="<?php echo isset($record->color) ? $record->color : '' ?>"
                                               name="color">
                                    </div>
                                </div>
                            </div>
