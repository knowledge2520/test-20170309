    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url($this->lang->lang().'/products/comments')?>"><?php echo lang('bc_comment')?></a>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet box blue-hoki">
                                    ...
                                    <div class="portlet-body">
                                        <div class="row">
                                            <?php echo form_open(site_url($this->lang->lang().'/products/comments/index'),'method="GET" name="form_searchResult" id="form_searchResult"')?>
                                        ...
                                        <?php echo form_open(site_url($this->lang->lang().'/products/comments/index'),'method="POST" name="form_listRecords" id="form_listRecords"')?>
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <tr>
                                                ...
                                                <?php endif;?>
                                                <th><?php echo lang('comment_id')?></th>                                                
                                                <th><?php echo lang('comment_user')?></th>
                                                <th><?php echo lang('comment_product')?></th>
                                                <th><?php echo lang('comment_comment')?></th>
                                                <th><?php echo lang('comment_rating')?></th>
                                                <th><?php echo lang('comment_status')?></th>
                                                <th><?php echo lang('comment_created_date')?></th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <?php if(!empty($records)):?>
                                                <?php foreach($records as $record):?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo ($record->status==0) ? lang('comment_status_deactivate') : lang('comment_status_active')?></td>
