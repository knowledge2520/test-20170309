...
class Transactions_model extends MY_Model
{
    ...
    protected $table_name	    = "user_transaction";
    protected $key			    = "id";
     ...
     *
     **/
    public function get_transaction_order($order_id=FALSE)
    {
        $this->trigger('get_transaction_order', $order_id);
    ...
    /**
     * get_transaction_product
     *
     **/
    public function get_transaction_product($product_id=FALSE)
    {
        $this->trigger('get_transaction_product', $product_id);
