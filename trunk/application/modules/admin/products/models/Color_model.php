...
class Color_model extends MY_Model
{
    ...
    protected $table_name	    = "pet_shop_product_color";
    protected $key			    = "id";
     ...
     *
     **/
    public function get_color_product($product_id=FALSE)
    {
        $this->trigger('get_color_product', $product_id);
    ...
    public function check_quantity_exist($color_id){
    	$this->table_name = 'pet_shop_product_quantity';
    	$return = $this->find_by('color_id', $color_id);
