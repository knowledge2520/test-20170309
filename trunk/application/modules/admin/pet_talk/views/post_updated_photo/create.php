    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url($this->lang->lang().'/pet_talk/mediaList/'.$newsfeed_id)?>"><?php echo lang('bc_pet_talk_media_list')?></a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <?php echo lang('bc_pet_talk_add')?>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light bordered form-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-blue-hoki bold uppercase"><?php echo lang('pet_talk_create')?></span>
                        </div>
                    </div>
