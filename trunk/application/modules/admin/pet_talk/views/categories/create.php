    ...
    <div class="page-content">
        ...
        <h3 class="page-title">
            <h3 class="page-title">
                ...
                <small><?php echo lang('category_create') ?></small>
            </h3>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li><a href="<?php echo site_url($this->lang->lang().'/pet_talk/categories')?>"><?php echo lang('bc_categories')?></a>
                    <i class="fa fa-angle-right"></i></li>
                <li><?php echo lang('bc_category_add')?></li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
        <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="portlet light bordered form-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-blue-hoki bold uppercase"><?php echo lang('category_add')?></span>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="max-width: 155px; max-height: 155x;">
                            ...
                            <div class="form-group <?php echo form_error('description') ? 'has-error' : ''; ?>">
                                <label class="control-label col-md-3"><?php echo lang('category_description')?> <span class="required" aria-required="true"> * </span></label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group <?php echo form_error('name') ? 'has-error' : ''; ?>">
                                <label class="control-label col-md-3"><?php echo lang('category_sort')?></label>
                                <div class="col-md-9">
                                     <input type="text" class="form-control" name="sort" value="<?php echo isset($record->sort) ? $record->sort : '';?>">
                                    <?php echo form_error('sort')?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label
                                    class="control-label col-md-3"><?php echo lang('category_popular') ?>
                                    :</label>
                                ...
                                <div class="col-md-9">
                                    ...
                                    $data = array(
                                        'name'      => 'popular',
                                        'value'     => TRUE,
                                        'checked'   => (isset($record->is_popular) && $record->is_popular != 0) ? TRUE : FALSE,
                                    );
