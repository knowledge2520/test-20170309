    ...
    <div class="page-content">
        ...
        <h3 class="page-title">
            <h3 class="page-title">
                ...
                <small><?php echo lang('pet_talk_info_lost_report') . ' ' . lang('pet_talk_info_create') ?></small>
            </h3>
        </h3>
        <div class="page-bar">
                            ...
                            <div class="form-group <?php echo form_error('when') ? 'has-error' : ''; ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group date form_datetime" data-date="<?php echo gmdate('Y-m-d',now())?>">
                                        <input type="text" name="when" size="16" class="form-control" readonly value="<?php echo isset($record->when) ? $record->when : date("d/m/Y H:i:s");?>">
                            ...
                            <div class="form-group <?php echo form_error('breed') ? 'has-error' : ''; ?>" id="pet-breed-selected">
                                ...
                                <div class="col-md-9">
                                    <?php 
                                        ...
                                        echo form_dropdown('breed-selected', $breeds, $oldBreed, 'class="form-control select2" id="pet-breed"');    
