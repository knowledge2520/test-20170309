                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group <?php echo form_error('age') ? 'has-error' : ''; ?>">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="age" value="<?php echo (isset($record) && !empty($record)) ? $record->age : "";?>">
                            ...
                            <div class="form-group <?php echo form_error('color') ? 'has-error' : ''; ?>">
                             ...
                             <div class="form-group <?php echo form_error('microchip') ? 'has-error' : ''; ?>">
                                ...
                                <div class="col-md-9">
                                     <input type="text" class="form-control" name="microchip" value="<?php echo (isset($record) && !empty($record)) ? $record->microchip : "";?>">
                            ...
                            <div class="form-group last <?php echo form_error('rewardCurrency') ? 'has-error' : ''; ?>">
                                <label class="control-label col-md-3"><?php echo lang('pet_talk_info_reward')?></label>
                                <div class="col-md-9">
                                     <input type="text" class="form-control" name="rewardCurrency" value="<?php echo (isset($record) && !empty($record)) ? $record->rewardCurrency : "";?>">
