    ...
    <div class="page-content">
        ...
        <h3 class="page-title">
            <h3 class="page-title">
                ...
                <small><?php echo lang('pet_talk_info_lost_report') . ' ' . lang('pet_talk_info_edit') ?></small>
            </h3>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    ...
                    <i class="fa fa-angle-right"></i></li>
                <li>
                    <a href="<?php echo site_url($this->lang->lang() . '/pet_talk/pet_talk_info?category=Lost+Report') ?>"><?php echo lang('bc_pet_talk_info_lost_report') ?></a>
                    <i class="fa fa-angle-right"></i></li>
                <li><?php echo lang('bc_pet_talk_info_edit') ?></li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
        <!-- BEGIN PAGE CONTENT-->
                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="col-md-9">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="max-width: 155px; max-height: 155px;">
                                                    <?php if(isset($cover_image->photo_thumb) && $cover_image->photo_thumb!=''):?>
                                                        <img src="<?php echo CMSHelper::output_media($cover_image->photo_thumb)?>" alt=""/>
                                                    <?php else:?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <strong><?php echo lang('pet_talk_info_important_information')?></strong>
                                        </div>
                                    </div>
                                    <div class="form-group <?php echo form_error('when') ? 'has-error' : ''; ?>">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group date form_datetime" data-date="<?php echo gmdate('Y-m-d',now())?>">
                                                <input type="text" name="when" size="16" class="form-control" readonly value="<?php echo isset($record->when) ? $record->when : '';?>">
                                    ...
                                    <div class="form-group <?php echo form_error('currency') ? 'has-error' : ''; ?>">
                                        <label class="control-label col-md-3"><?php echo lang('pet_talk_info_currency')?></label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="currency" value="<?php echo isset($record->currency) ? $record->currency : '';?>">
                                            <?php echo form_error('currency')?>
                                        </div>
                                    </div>
                                    <div class="form-group <?php echo form_error('rewardCurrency') ? 'has-error' : ''; ?>">
                                        <label class="control-label col-md-3"><?php echo lang('pet_talk_info_reward_currency')?></label>
                                        <div class="col-md-9">
                                            <?php 

                                                $currency = $this->config->item('currency');
                                                echo form_dropdown('rewardCurrency', $currency, '', 'class="form-control"');    
                                                echo form_error('rewardCurrency')
                                            ?>
                                            <?php echo form_error('rewardCurrency')?>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="control-label col-md-3"></label>
                                        <div class="col-md-9">
                                            <strong><?php echo lang('pet_talk_info_pet_profile')?></strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group <?php echo form_error('color') ? 'has-error' : ''; ?>">
                                        <label class="control-label col-md-3"><?php echo lang('pet_talk_info_color')?> <span class="required" aria-required="true"> * </span></label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="color" value="<?php echo isset($record->color) ? $record->color : '';?>">
                                            <?php echo form_error('color')?>
                                        </div>
                                    </div>
                                    <div class="form-group <?php echo form_error('microchip') ? 'has-error' : ''; ?>">
                                        <label class="control-label col-md-3"><?php echo lang('pet_talk_info_microchip')?></label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group last <?php echo form_error('user_id') ? 'has-error' : ''; ?>" >
                                       <label class="control-label col-md-3"><?php echo lang('pet_talk_info_owner')?></label>
                                        <div class="col-md-9">
                                            <input type="hidden" name="user_id" value="<?php echo isset($record->user_id) ? $record->user_id : '';?>">
                                            <input type="text" class="form-control" name="full_name" value="<?php echo isset($user) ? $user->first_name . ' ' . $user->last_name : '';?>" readonly>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <input type="hidden" name="infoType" value="<?php echo ADD_PETTALK_LOST_REPORT ;?>">                                
