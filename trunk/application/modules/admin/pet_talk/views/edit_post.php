                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="form-body">                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <?php 
                                            if(!empty($categories) && $record->category_id){  
                                                $category = isset($record->category_id) ? $record->category_id : 'newsfeed_post';
                                                echo form_dropdown('category_id', $categories, $category, 'class="form-control" id="topic-category"');
                                              }else{
                                                echo '<input type="text" class="form-control" name="category_id" value="Newsfeed Post" readonly>';
                                              }
                                            ?>
                                        </div>
                                    </div>
