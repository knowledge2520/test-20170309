    ...
    <div class="page-content">
        ...
        <h3 class="page-title">
            <h3 class="page-title">
                ...
                <small><?php echo lang('comment_create') ?></small>
            </h3>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    ...
                    <i class="fa fa-angle-right"></i></li>
                <li><?php echo lang('bc_comment_add') ?></li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
        <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="portlet light bordered form-fit">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span
                                class="caption-subject font-blue-hoki bold uppercase"><?php echo lang('comment_create') ?></span>
                        </div>
                    </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    <input type="hidden" name="topic_id" value="<?php echo isset($topic->id) ? $topic->id  : '' ;?>">
