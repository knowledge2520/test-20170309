    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url($this->lang->lang().'/pet_talk')?>"><?php echo lang('bc_pet_talk_info')?></a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                ...
                <li>
                    <?php echo lang('bc_pet_talk_info_photo')?>
                </li>
            </ul>
            <?php if(isset($number_photos) && $number_photos < 3) :?>
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown">
                        <?php echo lang('pet_talk_info_actions')?> <i class="fa fa-angle-down"></i>
                    </button>
                    <ul class="dropdown-menu pull-right" role="menu">
                        <li>
                            <a href="<?php echo site_url($this->lang->lang().'/pet_talk/pet_talk_info/mediaCreate/'.$pettalk_info_id)?>"><?php echo lang('pet_talk_info_add')?></a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="tabbable tabbable-custom tabbable-full-width">
                            <ul class="nav nav-tabs">
                                <li>
                                    <a href="<?php echo site_url($this->lang->lang().'/pet_talk/pet_talk_info/edit/'.$pettalk_info_id)?>">
                                        General</a>
                                </li>
                                <li  class="active">
                                    <a href="#">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <?php echo lang('pet_talk_info_photo')?>                                                            
                                                        </th>                                                        
                                                        <th>
                                                            <?php echo lang('pet_talk_info_status')?>
                                                        </th>                                                       
                                                        <th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    switch ($record->status){
                                                                        case 0: echo lang('pet_talk_info_status_deactivate');break;
                                                                        case 1: echo lang('pet_talk_info_status_active');break;
                                                                    }
                                                                    ;?>
                                                                </td>     
                                                                 <td><?php echo get_time_date($record->created_date) ?></td>
                                                                 <td>                                                            
                                                                    <a href="<?php echo site_url($this->lang->lang().'/pet_talk/pet_talk_info/mediaEdit/'.$pettalk_info_id.'/'.$record->id) ;?>"
