...
<div class="page-content-wrapper">
    <div class="page-content">			
        ...
        <h3 class="page-title">
            ...
            <small><?php echo lang('user_management') ?></small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo site_url($this->lang->lang() . '/users') ?>"><?php echo lang('bc_user_management') ?></a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <?php echo lang('bc_users') ?>
                </li>
            </ul>
            <?php if(isset($permissions[$module.'.create']) || isset($permissions['users.groups.index']) || $is_admin):?>
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown">
                        <?php echo lang('user_actions') ?> <i class="fa fa-angle-down"></i>
                    </button>                    
                    <ul class="dropdown-menu pull-right" role="menu">
                        <?php if(isset($permissions[$module.'.create']) || $is_admin):?>
                        <li>
                            <a href="<?php echo site_url($this->lang->lang() . '/users/create') ?>"><?php echo lang('user_create') ?></a>
                        </li>
                        <?php endif;?>
                        <?php if(isset($permissions['users.groups.index']) || $is_admin):?>
                        <li>
                            <a href="<?php echo site_url($this->lang->lang() . '/users/groups/index') ?>"><?php echo lang('user_groups') ?></a>
                        </li>
                        <?php endif;?>
                    </ul>                    
                </div>
                ...
                <div class="portlet-body">
                    ...
                    <div class="tabbable tabbable-custom tabbable-full-width">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="<?php echo site_url($this->lang->lang() . '/users/index') ?>">
                                    <?php echo lang('user_tab_list') ?> </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url($this->lang->lang() . '/users/groups/index') ?>">
                                    <?php echo lang('user_tab_groups') ?> </a>
                            </li>
                        </ul>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet box blue-hoki">
                                            ...
                                            <div class="portlet-body">	
                                                <div class="row">
                                                    <?php echo form_open(site_url($this->lang->lang() . '/users/index'), 'method="GET" name="form_searchResult" id="form_searchResult"') ?>
                                                ...
                                                <?php echo form_open(site_url($this->lang->lang() . '/users/index'), 'method="POST" name="form_listRecords" id="form_listRecords"') ?>
                                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <a class="header-table" href="<?php echo get_url_query($current_url, $query_url, ['order_field' => 'first_name', 'sort' => $order_field == "first_name" ? ($sort == "DESC" ? "ASC" : "DESC") : "DESC"]);?>" >
                                                                <?php 
                                                                    echo lang('user_fullname') . ' ';
                                                            ...
                                                            <th>
                                                                <a class="header-table" href="<?php echo get_url_query($current_url, $query_url, ['order_field' => 'country', 'sort' => $order_field == "country" ? ($sort == "DESC" ? "ASC" : "DESC") : "DESC"]);?>" >
                                                                <?php 
                                                                    echo lang('user_country') . ' ';
                                                            ...
                                                            <th>
                                                                <a class="header-table" href="<?php echo get_url_query($current_url, $query_url, ['order_field' => 'created_on', 'sort' => $order_field == "created_on" ? ($sort == "DESC" ? "ASC" : "DESC") : "DESC"]);?>" >
                                                                <?php 
                                                                    echo lang('user_created_on') . ' ';
                                                                    if($order_field == 'created_on'){
                                                                        if($sort == 'DESC'){
                                                                            echo '<span class="fa fa-sort-desc span-header-table"></span>';
                                                                        }else{
                                                                            echo '<span class="fa fa-sort-asc span-header-table"></span>';
                                                            ...
                                                            <th>
                                                                <a class="header-table" href="<?php echo get_url_query($current_url, $query_url, ['order_field' => 'last_login', 'sort' => $order_field == "last_login" ? ($sort == "DESC" ? "ASC" : "DESC") : "DESC"]);?>" >
                                                                <?php 
                                                                    echo lang('user_last_login') . ' ';
                                                    ...
                                                    <tbody>
                                                        <?php if(!empty($records)): $no = $offset +1;?>
                                                            ...
                                                            foreach ($records as $record):
                                                                $groups = '';
                                                                if (isset($record->groups) && !empty($record->groups)) {
                                                                    $arr = array();
                                                                    foreach ($record->groups as $ugroup) {
                                                                        $arr[] .= $ugroup->name;
                                                                    }
                                                                    $groups = implode(', ', $arr);
                                                                }
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $groups ? $groups : "Member user"?></td>
                                                                    <td><?php echo get_time_date($record->created_on) ?></td>
                                                                    <td><?php echo get_time_date($record->last_login);?></td>
                                                                    <?php if(isset($permissions[$module.'.edit']) || $is_admin):?>
                                                                        <td>  
                                                                            <div class="status" onchange='set_status("<?php echo $record->id;?>", "<?php echo $_SERVER['REQUEST_URI'];?>")'>
                                                                                <label>
                                                                                    <?php
                                                                                        $active = array(
                                                                                            1 => lang('index_active_link'),
                                                                                            0 => lang('index_inactive_link')
                                                                                        );
                                                                                    ?>
                                                                                    <?php echo form_dropdown('active', $active, $record->active,'class="form-control input-inline" id="status_'.$record->id.'" ')?>
                                                                                    
                                                                                </label>
                                                                            </div>
                                                                        </td>
                                                                    <?php else:?>
                                                                        <td><?php echo ($record->active) ? lang('index_active_link') : lang('index_inactive_link'); ?></td>
                                                                    <?php endif;?>
                                                                    <?php if(isset($permissions[$module.'.edit']) || $is_admin ):?>
                                                                        <td>                                                            
                                                                            <a href="<?php echo site_url($this->lang->lang() . '/users/edit/' . $record->id) ;?>"
