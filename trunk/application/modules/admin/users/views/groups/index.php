...
<div class="page-content">
    <!-- BEGIN PAGE HEADER-->
    <h3 class="page-title">
        <?php echo lang('groups_management')?>
    </h3>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="<?php echo site_url($this->lang->lang().'/users/groups')?>"><?php echo lang('bc_groups')?></a>
            </li>
        </ul>
        ...
        <div class="page-toolbar">
            <div class="btn-group pull-right">
                <button type="button" class="btn btn-fit-height grey-salt dropdown-toggle" data-toggle="dropdown">
                    <?php echo lang('group_actions')?> <i class="fa fa-angle-down"></i>
                </button>
                <ul class="dropdown-menu pull-right" role="menu">
                    <li>
                        <a href="<?php echo site_url($this->lang->lang().'/users/groups/create')?>"><?php echo lang('user_create')?></a>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet box blue-hoki">
                                        ...
                                        <div class="portlet-body">
                                            <div class="row">
                                                <?php echo form_open(site_url($this->lang->lang().'/users/groups/index'),'method="GET" name="form_searchResult" id="form_searchResult"')?>
                                            ...
                                            <?php echo form_open(site_url($this->lang->lang().'/users/groups/index'),'method="POST" name="form_listRecords" id="form_listRecords"')?>
                                                ...
                                                <?php if(!empty($records)): $no = $offset +1;?>
                                                    <?php foreach($records as $record):?>
                                                        <tr>
                                                            ...
                                                            <?php if(isset($permissions[$module.'.edit']) || $is_admin):?>
                                                            <td>                                                  
                                                                <a href="<?php echo site_url($this->lang->lang().'/users/groups/edit/'.$record->id) ;?>" class="btn default btn-xs green-meadow"><i class="fa fa-edit"></i> Edit</a>&nbsp;&nbsp;
                                                                <?php if(($record->id != 1) || $is_admin): ?>
                                                                    <a href="<?php echo site_url($this->lang->lang().'/users/permissions/edit/'.$record->id) ;?>" class="btn default btn-xs purple"><i class="fa fa-eye"></i> View Permission</a>
                                                                <?php  endif;?>                                                                
                                                            </td>
                                                            <?php endif;?>
                                                        </tr>
