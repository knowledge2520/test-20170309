...
//class MY_Lang extends CI_Lang {
  ...
  ***************************************************/
  ...
  private $special = array (
      "admin", "home", "contact", "policy", "privacypolicy", "auth", "content", "account_already_active", "email_verification_complete", "activation_unsuccessful", "pet", "tag", "search-badge", "assets", "welcome","*", "doc", "statistic", "command", "themes", "cronjob"
  );
  ...
  function MY_Lang()
  {
    ...
    $tag_url = 'tag/' . $URI->uri_string();
    $this->tag_uri = $tag_url;//$RTR->default_controller;
    ...
    { 
      ...
      $uri = (!empty($this->uri)) ? $this->tag_uri : $this->uri . $this->default_uri;
