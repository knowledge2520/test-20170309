...
class BF_Model extends CI_Model
{
	...
	public function find_by($field='', $value='', $type='and')
	{
		...
		{
			$this->error = lang('RML_Model_find_error');
			$this->logit('['. get_class($this) .': '. __METHOD__ .'] '. lang('RML_Model_find_error'));
			return FALSE;
		}
	...
	public function delete($id=NULL)
	{
		...
		$this->error = sprintf(lang('RML_Model_db_error'), $this->get_db_error_message());
	...
	public function delete_where($where=NULL)
	{
		...
		$this->error = lang('RML_Model_db_error') . $this->get_db_error_message();
	...
	public function is_unique($field='', $value='')
	{
		...
		{
			$this->error = lang('RML_Model_unique_error');
			$this->logit('['. get_class($this) .': '. __METHOD__ .'] '. lang('RML_Model_unique_error'));
			return FALSE;
		}
	...
	public function count_by($field='', $value=NULL)
	{
		if (empty($field))
		{
			$this->error = lang('RML_Model_count_error');
			$this->logit('['. get_class($this) .': '. __METHOD__ .'] '. lang('RML_Model_count_error'));
			return FALSE;
		}
	...
	public function get_field($id=NULL, $field='')
	{
		...
		{
			$this->error = lang('RML_Model_fetch_error');
			$this->logit('['. get_class($this) .': '. __METHOD__ .'] '. lang('RML_Model_fetch_error'));
			return FALSE;
		}
	 ...
	 *
	 * @return RML_Model An instance of this class.
	 */
 ...
 * MY_Model
 *
 * This simply extends RML_Model for backwards compatibility,
