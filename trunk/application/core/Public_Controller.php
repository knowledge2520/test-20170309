...
class Public_Controller extends Base_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->pager = array(
            ...
            'full_tag_close'    => '</div>',
            'first_link'         => '<img border="0" alt="" src="http://www.news.bayer.com/baynews/baynews.nsf/files/relaunch/$file/nav-first.gif" class="viewnavicon">',
            'next_link'         => '<img border="0" alt="" src="http://www.news.bayer.com/baynews/baynews.nsf/files/relaunch/$file/nav-next.gif" class="viewnavicon">',
            'prev_link'         => '<img border="0" alt="" src="http://www.news.bayer.com/baynews/baynews.nsf/files/relaunch/$file/nav-previous.gif" class="viewnavicon">',
            'last_link'			=> '<img border="0" alt="" src="http://www.news.bayer.com/baynews/baynews.nsf/files/relaunch/$file/nav-last.gif" class="viewnavicon">',
            'next_tag_open'     => '<img border="0" alt="" src="http://www.news.bayer.com/baynews/baynews.nsf/files/relaunch/$file/nav-delimiter.gif" class="viewnavdelimiter"><a>',
            'next_tag_close'    => '</a>',
            'prev_tag_open'     => '<img border="0" alt="" src="http://www.news.bayer.com/baynews/baynews.nsf/files/relaunch/$file/nav-delimiter.gif" class="viewnavdelimiter"><a>',
            'prev_tag_close'    => '</a>',
            'first_tag_open'    => '<img border="0" alt="" src="http://www.news.bayer.com/baynews/baynews.nsf/files/relaunch/$file/nav-delimiter.gif" class="viewnavdelimiter"><a>',
            'first_tag_close'   => '</a>',
            'last_tag_open'     => '<img border="0" alt="" src="http://www.news.bayer.com/baynews/baynews.nsf/files/relaunch/$file/nav-delimiter.gif" class="viewnavdelimiter"><a>',
            'last_tag_close'    => '</a>',
            'cur_tag_open'      => '<img border="0" alt="" src="http://www.news.bayer.com/baynews/baynews.nsf/files/relaunch/$file/nav-delimiter.gif" class="viewnavdelimiter"><a class="current"><b>',
            'cur_tag_close'     => '</b></a>',
            'num_tag_open'      => '<img border="0" alt="" src="http://www.news.bayer.com/baynews/baynews.nsf/files/relaunch/$file/nav-delimiter.gif" class="viewnavdelimiter"><a>',
            'num_tag_close'     => '</a>',
        );
//         $this->limit = $this->settings_lib->item('site.list_limit');
        ...
        if (count($this->assets_js['core_plugin']) > 0)
        {
            ...
            foreach($this->assets_js['core_plugin'] as $asset)
                if (stristr($asset, 'http') === FALSE)
                    $this->template->append_scriptdata('<script type="text/javascript" src="' . $this->config->item('base_url') . '../../themes/public/js/' . $asset . '"></script>');
                else
    ...
    public function render_page($page, $data = array())
    {
        ...
        $this->template
            ->set_partial('header', 'partials/public/header');
